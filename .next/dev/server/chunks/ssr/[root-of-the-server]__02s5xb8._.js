...
;
const metadata = {
    title: 'Mohammad Yassin | Network Engineer',
    description: 'Computer Engineering graduate with 5+ years enterprise networking experience. Specializing in Fortinet, BGP/OSPF, and network security.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
